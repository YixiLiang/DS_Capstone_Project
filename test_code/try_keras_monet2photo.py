...
#%%
# Load the monet2photo dataset using tensorflow-datasets.
...
# Callbacks
plotter = GANMonitor()
checkpoint_filepath = "./model_checkpoints/cyclegan_checkpoints_monet_10Train.{epoch:03d}"
...
# load previous model
# use train model
weight_file = "./model_checkpoints/cyclegan_checkpoints_monet_10Train.014"
...
_, ax = plt.subplots(4, 2, figsize=(10, 15))
for i, img in enumerate(test_monet.take(4)):
