...
# Callbacks
plotter = GANMonitor()
checkpoint_filepath = "./model_checkpoints/cyclegan_checkpoints_chinese_2Train.{epoch:03d}"
...
# load previous model
# use train model
weight_file = "./model_checkpoints/cyclegan_checkpoints_chinese_1Train.020"
